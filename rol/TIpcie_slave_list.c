/*************************************************************************
 *
 *  TIpcie_slave_list.c - Library of routines for readout of
 *                         events using user defined routine in CODA 3.0
 *
 */

/* TS / TI-Master trigger source (e.g. Fiber input), POLL for available data */
...
const char *configFile = "/daqfs/home/moffit/work/TIpcie/cfg/slave.ini";
...
/*
  Local Variables:
  compile-command: "make -k -B TIpcie_slave_list.so"
  End:
 */
